...
namespace Unity.Animations.SpringBones
{
    public class SpringBoneWindow : EditorWindow
    {
        ...
        private const string kIconProjectPath = "Assets/UnityChanSpringBone/Editor/GUI/Icons";
        ...
        private void InitializeIcons()
        {
            ...
            headerIcon ??= LoadIcon(kIconProjectPath, "SpringIcon.tga");
            
            newDocumentIcon = LoadIcon(kIconDirectoryPath, "NewDocumentHS.png");
            newDocumentIcon ??= LoadIcon(kIconProjectPath, "NewDocumentHS.png");
            
            openDocumentIcon = LoadIcon(kIconDirectoryPath, "OpenHH.bmp");
            openDocumentIcon ??= LoadIcon(kIconProjectPath, "OpenHH.bmp");
            
            saveDocumentIcon = LoadIcon(kIconDirectoryPath, "SaveHH.bmp");
            saveDocumentIcon ??= LoadIcon(kIconProjectPath, "SaveHH.bmp");
            
            deleteIcon = LoadIcon(kIconDirectoryPath, "Delete.png");
            deleteIcon ??= LoadIcon(kIconProjectPath, "Delete.png");
            
            pivotIcon = LoadIcon(kIconDirectoryPath, "Pivot.png");
            pivotIcon ??= LoadIcon(kIconProjectPath, "Pivot.png");
            
            sphereIcon = LoadIcon(kIconDirectoryPath, "SpringSphereIcon.tga");
            sphereIcon ??= LoadIcon(kIconProjectPath, "SpringSphereIcon.tga");
            
            capsuleIcon = LoadIcon(kIconDirectoryPath, "SpringCapsuleIcon.tga");
            capsuleIcon ??= LoadIcon(kIconProjectPath, "SpringCapsuleIcon.tga");
            
            panelIcon = LoadIcon(kIconDirectoryPath, "SpringPanelIcon.tga");
            panelIcon ??= LoadIcon(kIconProjectPath, "SpringPanelIcon.tga");
        }
